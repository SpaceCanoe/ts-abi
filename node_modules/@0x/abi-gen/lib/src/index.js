...
for (const abiFileName of abiFileNames) {
    ...
    const methodsData = _.map(methodAbis, (methodAbi, methodAbiIndex) => {
        ...
        const methodData = Object.assign({}, methodAbi, { singleReturnValue: methodAbi.outputs.length === 1, hasReturnValue: methodAbi.outputs.length !== 0, languageSpecificName,
    ...
    const eventsData = _.map(eventAbis, (eventAbi, eventAbiIndex) => {
        ...
        const eventData = Object.assign({}, eventAbi, { languageSpecificName });
        return eventData;
    });
