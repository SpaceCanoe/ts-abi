...
export type PancakeMasterChefEventArgs =
    | PancakeMasterChefDepositEventArgs
    | PancakeMasterChefEmergencyWithdrawEventArgs
    | PancakeMasterChefOwnershipTransferredEventArgs
    | PancakeMasterChefWithdrawEventArgs;

export enum PancakeMasterChefEvents {
    Deposit = 'Deposit',
...
export interface PancakeMasterChefDepositEventArgs extends DecodedLogArgs {
    user: string;
    pid: BigNumber;
    amount: BigNumber;
}

export interface PancakeMasterChefEmergencyWithdrawEventArgs extends DecodedLogArgs {
    user: string;
    pid: BigNumber;
    amount: BigNumber;
}

export interface PancakeMasterChefOwnershipTransferredEventArgs extends DecodedLogArgs {
    previousOwner: string;
    newOwner: string;
}

export interface PancakeMasterChefWithdrawEventArgs extends DecodedLogArgs {
    user: string;
    pid: BigNumber;
    amount: BigNumber;
}
...
export class PancakeMasterChefContract extends BaseContract {
    /**
     * @ignore
     */
public static deployedBytecode: string | undefined;
public static contractName = 'PancakeMasterChef';
    private readonly _methodABIIndex: { [name: string]: number } = {};
private readonly _subscriptionManager: SubscriptionManager<PancakeMasterChefEventArgs, PancakeMasterChefEvents>;
public static async deployFrom0xArtifactAsync(
        ...
        logDecodeDependencies: { [contractName: string]: (ContractArtifact | SimpleContractArtifact) },
            ...
            _syrup: string,
            _devaddr: string,
            _cakePerBlock: BigNumber,
            _startBlock: BigNumber,
    ): Promise<PancakeMasterChefContract> {
        ...
        return PancakeMasterChefContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly, _cake,
_syrup,
_devaddr,
_cakePerBlock,
_startBlock
    ...
    public static async deployWithLibrariesFrom0xArtifactAsync(
        ...
        const libraryAddresses = await PancakeMasterChefContract._deployLibrariesAsync(
            artifact,
            libraryArtifacts,
...
_startBlock
        ...
        logUtils.log(`PancakeMasterChef successfully deployed at ${txReceipt.contractAddress}`);
        const contractInstance = new PancakeMasterChefContract(txReceipt.contractAddress as string, provider, txDefaults, logDecodeDependencies);
...
_startBlock
        ...
        for (const link of Object.values(links)) {
            for (const libraryName of Object.keys(link)) {
                if (!libraryAddresses[libraryName]) {
                    ...
                    await PancakeMasterChefContract._deployLibrariesAsync(
                        libraryArtifact,
                        libraryArtifacts,
                        web3Wrapper,
                        txDefaults,
    ...
    public getFunctionSignature(methodName: string): string {
        ...
        const methodAbi = PancakeMasterChefContract.ABI()[index] as MethodAbi; // tslint:disable-line:no-unnecessary-type-assertion
    ...
    public getABIDecodedTransactionData<T>(methodName: string, callData: string): T {
        ...
        const self = (this as any) as PancakeMasterChefContract;
...
> {
        const self = this as any as PancakeMasterChefContract;
            assert.isBigNumber('_allocPoint', _allocPoint);
            assert.isString('_lpToken', _lpToken);
            assert.isBoolean('_withUpdate', _withUpdate);
...
> {
        const self = this as any as PancakeMasterChefContract;
            assert.isString('_devaddr', _devaddr);
...
> {
        const self = this as any as PancakeMasterChefContract;
            assert.isBigNumber('_from', _from);
            assert.isBigNumber('_to', _to);
...
> {
    ...
    public poolInfo(
            index_0: BigNumber,
    ): ContractTxFunctionObj<[string, BigNumber, BigNumber, BigNumber]
> {
        const self = this as any as PancakeMasterChefContract;
...
> {
        const self = this as any as PancakeMasterChefContract;
            assert.isString('_migrator', _migrator);
...
> {
    ...
    public updateMultiplier(
            multiplierNumber: BigNumber,
    ): ContractTxFunctionObj<void
> {
        const self = this as any as PancakeMasterChefContract;
            assert.isBigNumber('multiplierNumber', multiplierNumber);
...
> {
     ...
     */
    public subscribe<ArgsType extends PancakeMasterChefEventArgs>(
        eventName: PancakeMasterChefEvents,
        indexFilterValues: IndexedFilterValues,
        callback: EventCallback<ArgsType>,
        isVerbose: boolean = false,
        blockPollingIntervalMs?: number,
    ): string {
        assert.doesBelongToStringEnum('eventName', eventName, PancakeMasterChefEvents);
     ...
     */
    public async getLogsAsync<ArgsType extends PancakeMasterChefEventArgs>(
        eventName: PancakeMasterChefEvents,
    ...
    constructor(
        ...
        txDefaults?: Partial<TxData>,
        logDecodeDependencies?: { [contractName: string]: ContractAbi },
        deployedBytecode: string | undefined = PancakeMasterChefContract.deployedBytecode,
    ) {
...
this._subscriptionManager = new SubscriptionManager<PancakeMasterChefEventArgs, PancakeMasterChefEvents>(
            PancakeMasterChefContract.ABI(),
            this._web3Wrapper,
        );
